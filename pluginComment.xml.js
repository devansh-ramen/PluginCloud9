...
'        <a:button style="float:left;width:50%;display:inline" onclick="require(\'core/ext\').extLut[\'ext/livecoffee/livecoffee\'].validateLoginDetails( document.getElementById('txtusername') )">Login</a:button>\n' +
//'        </a:td>\n' +
//'        <a:td>\n' +
